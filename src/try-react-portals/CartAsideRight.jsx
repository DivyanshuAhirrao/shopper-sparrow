...
<aside className="w-[364.5px] h-[100vh] bg-slate-100 border-l-2 border-gray-800 flex flex-col gap-3 items-center p-4 sticky top-0">
          ...
          <div className="h-[130px] w-[100%] border-b-2 border-gray-200 pt-1 flex flex-col justify-evenly">
            ...
            <h5 className="font-mono text-center">
              ...
              OFF on First 2 Orders !!{" "}
            </h5>
          </div>

            {/* Donation Section */}
            <div className="h-[225px] w-[100%] border-b-2 border-gray-200 pt-1 flex flex-col">
            <h1 className="uppercase text-gray-800 font-bold text-[12px] py-2"> Support Transformative social work in india </h1>
            <article className="w-[100%] flex pt-2">
              <form >
                <input type="checkbox" id="bug-four" name="bug-four" onChange={handleClick} className="scale-[1.5] absolute" value="Agree"/>
              </form>
              <p className="pl-6 relative bottom-2"> “Agree, if your aware and your generous donation helps us get that important work done.” </p>
            </article>
           <article className="flex gap-3 py-4">
            <button className="border-2 border-gray-300 rounded-[20px] px-6 py-1 font-mono text-[16px] hover:bg-red-100">₹10</button>
            <button className="border-2 border-gray-300 rounded-[20px] px-6 py-1 font-mono text-[16px] hover:bg-red-100">₹50</button>
            <button className="border-2 border-gray-300 rounded-[20px] px-6 py-1 font-mono text-[16px] hover:bg-red-100">₹100</button>
           </article>
           <p className="text-red-500 font-bold hover:text-[17px] transition-all duration-200 cursor-pointer"> Know More</p>
          </div>

           {/* Price Section */}
           <div className="h-[280px] w-[100%] border-b-2 border-gray-200 pt-1 flex flex-col">
            <h1 className="uppercase text-gray-600 font-bold text-[15px]">PRICE DETAILS (<span className="text-gray-900">1 Items </span>)</h1>
            <article className="px-2 h-[150px] flex flex-col justify-evenly">
                ...
                <div className="flex justify-between font-semibold text-gray-700">
                    <p>Coupon Discount </p>
                   <h6 className="text-green-500">-₹500</h6>
                </div>
                <div className="flex justify-between font-semibold text-gray-700">
                ...
                <div className="flex justify-between font-semibold text-gray-700">
                   ...
                   <h6> <strike className="pr-1 text-[13px]">₹69</strike> <span className="text-green-500">FREE</span> </h6>
                </div>
            ...
            <article className="px-2">
                <button className="w-[100%] bg-pink-500 py-2 text-white font-bold tracking-wide rounded-sm hover:text-[18px] transition-all duration-300 cursor-pointer">PLACE ORDER</button>
            </article>
