...
const CartAsideRight = ({ props }) => {
  ...
  const handlePayment = () => {
    toast("Soon to add Payment Functionality !!", {
      icon: "💳",
      style: {
        borderRadius: "10px",
        background: "#333",
        ...
        <div className="h-[280px] w-[100%] border-b-2 border-gray-200 pt-1 flex flex-col">
          ...
          <article className="px-2">
            <button
              ...
              className="w-[100%] bg-pink-500 py-2 text-white font-bold tracking-wide rounded-sm hover:text-[18px] transition-all duration-300 cursor-pointer"
            >
              PLACE ORDER
            </button>
          </article>
