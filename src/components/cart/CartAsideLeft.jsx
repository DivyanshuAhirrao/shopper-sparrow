  ...
  return (
    <>
      <aside className="w-[740px] h-[100vh] bg-slate-100 flex flex-col items-center gap-2 p-4">
        <article className="h-[33%] bg-slate-100 border-2 py-2 border-gray-200 w-[100%] rounded-[4px]">
        ...
        {items.length === 0 ? (
          <div className="scale-90 relative bottom-8 h-[67%]">
            <aside className="">
              <EmptyCart />
            </aside>
          ...
          <div className="scroller border-2 h-[67%] overflow-y-scroll border-gray-200 w-[100%] rounded-[4px] p-4">
            <section className="flex flex-col gap-2">
              {items.map((e) => {
